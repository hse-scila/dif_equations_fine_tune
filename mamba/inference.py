...
model_path = "./mamba_diffeq_large/checkpoint-50000"
...
def batch_generate_predictions(dataset, batch_size=16):
    all_predictions = []
...
pd.DataFrame(test_dataset).to_csv("results_large.csv", index=False, encoding='utf-8', escapechar="\\")
